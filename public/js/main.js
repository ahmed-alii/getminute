const left_panel_toggler = document.querySelector("body > main > aside.left-aside > button.toggler");
const right_panel_toggler = document.querySelector("body > main > aside.right-aside > button.toggler");
const grid = document.querySelector("body > main");
